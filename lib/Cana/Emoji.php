...
class Cana_Emoji extends Cana_Model {
	public static $maps = [
		'names' => [
	...
	//Cana_Emoji::maps['html_to_unified'] = array_flip(Cana_Emoji::maps['unified_to_html']);
	...
	public static function emoji_docomo_to_unified(	$text){ return self::convert($text, 'docomo_to_unified'); }
	public static function emoji_kddi_to_unified(		$text){ return self::convert($text, 'kddi_to_unified'); }
	public static function emoji_softbank_to_unified(	$text){ return self::convert($text, 'softbank_to_unified'); }
	public static function emoji_google_to_unified(	$text){ return self::convert($text, 'google_to_unified'); }
	...
	public static function emoji_unified_to_docomo(	$text){ return self::convert($text, 'unified_to_docomo'); }
	public static function emoji_unified_to_kddi(		$text){ return self::convert($text, 'unified_to_kddi'); }
	public static function emoji_unified_to_softbank(	$text){ return self::convert($text, 'unified_to_softbank'); }
	public static function emoji_unified_to_google(	$text){ return self::convert($text, 'unified_to_google'); }
	public static function unifiedToHtml(		$text){ return self::convert($text, 'unified_to_html'); }
	public static function emoji_html_to_unified(		$text){ return self::convert($text, 'html_to_unified'); }



	public static function convert($text, $map){
	...
	public static function emoji_get_name($unified_cp){
		...
		return self::$maps['names'][$unified_cp] ? self::$maps['names'][$unified_cp] : '?';
	}
}